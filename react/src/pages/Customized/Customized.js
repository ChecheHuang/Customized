...
function Customized(props) {
  ...
  useEffect(()=>{
    if(cartData.length!==0){
      const backgroundUrl = require(`../../images/CustomizedPhotos/${cartData[0].imageFront}/${cartData[0].images}`).default
      ...
      <div className="customizedTitle mt-5">
        ...
        <div className="container">
          <div className="row">
            ...
            {cartData.length !==0 && <div className="middleAndRightAside" style={{backgroundImage:`url(${backgroundUrl})`}} >
      </div> }
            <Middle
              data={products}
              cartData={cartData}
